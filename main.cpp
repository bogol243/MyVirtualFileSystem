...
//
// Между операциями открытия, записи и чтения, управление может перехватывать другой поток,
// который также будет выполнять эти операции для своего файла. Необходимо, чтобы система продолжала
// исправно функционировать в таком режиме работы, т.е. целостность данных не была нарушена.
// 
// ожидаемое поведение: 
//	для каждого файла, считанные данные соответствуют записанным ранее данным.
